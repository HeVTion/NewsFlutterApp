class BookModel {
	...
	BookModel({this.msg, this.code, this.data});

	BookModel.fromJson(Map<String, dynamic> json) {
		msg = json['msg'];
		code = json['code'];
		if (json['data'] != null) {
			data = new List<BookData>();(json['data'] as List).forEach((v) { data.add(new BookData.fromJson(v)); });
		}
	}
